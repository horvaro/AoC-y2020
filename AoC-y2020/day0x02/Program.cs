...
namespace day0x02
{
    ...
    {
        #region input
        public static string INPUT1 = @"1-8 n: dpwpmhknmnlglhjtrbpx
...
6-7 q: qqqqvqhq";
        ...
        static void Main(string[] args)
        {
            ...
            foreach (var line in INPUT1.Split(Environment.NewLine))
            {
                ...
                //read character
                var split2 = policy.Split(' ');
                var limits = split2[0];
                var character = Char.Parse(split2[1]);

                //read limits
                var split3 = limits.Split('-');
                var lowerLimit = StrToInt(split3[0]);
                var upperLimit = StrToInt(split3[1]);
